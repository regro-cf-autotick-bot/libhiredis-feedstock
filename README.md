...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/libhiredis-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/libhiredis-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi global install libhiredis
```
...
It is possible to list all of the versions of `libhiredis` available on your platform:
...
```
pixi search libhiredis --channel conda-forge
```
